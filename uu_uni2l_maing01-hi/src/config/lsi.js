const Lsi = {
  ...
  about: {
    header: {
      cs: "O aplikaci uuUni2l",
      en: "About application uuUni2l",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní uuUni2l.",
      en: "You can buy your own uuUni2l.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci uuUni2l.",
      en: "You don't have rights to initialize this uuUni2l.",
    },
  },
